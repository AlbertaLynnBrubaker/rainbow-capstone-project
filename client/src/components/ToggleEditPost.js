    ...
    return(
      <Styles>
        <Link to={`/${post.user.username}`} onClick={() => setPage(0)} className="user-banner">
          ...
          {post.group_data.title ? <><img src={post.group_data.avatar}  alt="group avatar" className='group-avatar-img'/>
    ...
    return(
      <Styles>
        <Link to={`/${post.user.username}` } onClick={() => setPage(0)} className="user-banner">
          ...
          <h5 className='user-avatar-text'>{post.user.full_name}</h5>
          <h6 className='user-avatar-text'>{`(${post.user.pronouns})`}</h6>
          <Link to={`/groups/${post.group_data.title}`} onClick={() => setPage(0)} className="user-banner">{post.group_data.title ? <>
